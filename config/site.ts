export const siteConfig = {
  ...
  experience: [
    ...
    },
    {
      ...
      technologies: ["Angular", "Jenkins", "SCSS", "REST APIs", "Agilen/Scrum", "Git"],
    },
    {
      company: "MetechVN",
      position: "Web Developer",
      duration: "2021 - 2022",
      description: "CRM, Building management system",
      technologies: ["JavaScript", "Angular", "TypeScript", "SCSS", "Git", "C#", "SQL", "REST APIs", "Agile/Scrum", "Docker", "Jetbrains", "Visual Studio", "Jenkins", "Git"],
    },
  ],
